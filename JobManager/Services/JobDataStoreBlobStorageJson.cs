...
namespace JobManager.Services
{
    class JobDataStoreBlobStorageJson : IJobDataStore<Job>
    {
        ...
        private static string ConnectionString => "DefaultEndpointsProtocol=https;AccountName=isp1004students1;AccountKey=C0U36cHkZoANkoeVjDYQRVjcEZwET+SEIufFAKdFRh9MKTDvlVvbulWTkLqD/zHKjQISqNBBYkW1+ASt2xmhLQ==;EndpointSuffix=core.windows.net"; // connection string is hidden because it was mentioned in task to hide it for security purpose
